...
# @Last Modified time: 2023-06-01 15:52:06
import torch
...
if __name__ == '__main__':
    full_data = CovidDataset('./data/data_feature.csv', './data/data_infection.csv')
    # train_data, test_data = torch.utils.data.random_split(full_data, [, 4000])
    train_data, test_data = torch.utils.data.random_split(full_data, [67200, 16800])
    ...
    print("Done!")
    # torch.save(model.state_dict(), 'model_5_11.pth')
