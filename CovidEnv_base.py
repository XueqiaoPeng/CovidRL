...
# @Last Modified time: 2023-06-09 15:37:15
import gym
...
class CovidEnv(gym.Env):
    ...
    def reset(self):
        ...
        for day in range(0, self.days - 1):
            self.input_data[5][day] = self.test
    ...
    def step(self, action):
        ...
        # reward = (-1 * sum1 - self.ratio * sum2)*100
